...
function enable_firewall() {
  echo -e "We are now setting up firewall to allow connections on port ${RED}$COIN_PORT${NC}"
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status BITMONEY.service${NC}"
 echo -e "================================================================================================================================"
}
